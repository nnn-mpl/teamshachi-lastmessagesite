            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div className={accountCardClasses}>
                    <div className="flex items-center mb-4">
                         <div className="p-1 border-2 border-dashed border-pink-300 rounded-full">
                            <div className="w-12 h-12 rounded-full bg-sky-100 flex items-center justify-center">
                                <svg className="w-8 h-8 text-sky-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div className="text-center mt-6">
                         <a href={twitterUrl} target="_blank" rel="noopener noreferrer" className="bg-sky-400 hover:bg-sky-500 text-white font-bold py-2 px-6 rounded-full transition-colors duration-300 shadow-md">
                            もっと見る
                        </a>
                    </div>
                </div>
